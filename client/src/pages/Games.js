          ...
          <div className="cards-row-container">
            <div className="item-card">
              <div className="title-bar card-bar">
                <a href>Crash Badicoot</a>
                <svg width={40} height={19} viewBox="0 0 24 24" fill="rgb(157, 49, 49)" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="item-img-div">
                <img src="https://www.mobygames.com/images/covers/l/86029-crash-bandicoot-playstation-front-cover.jpg" alt="" />
              </div>
            ...
            <div className="item-card">
              ...
              <div className="item-img-div">
                <img src="https://www.mobygames.com/images/covers/l/148357-the-sims-2-pets-playstation-2-front-cover.png" alt="" />
              </div>
              <div className="shadow card-shadow" />
            </div>
            <div className="item-card">
              ...
              <div className="item-img-div">
                <img src="https://www.mobygames.com/images/covers/l/252114-star-fox-adventures-gamecube-front-cover.jpg" alt="" />
              </div>
              <div className="shadow card-shadow" />
            </div>
          </div>
